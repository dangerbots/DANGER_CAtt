...
SLAP_TEMPLATES = [
    "[{user1}]({USERNAME}) {hits} {victim} with a {item}.",
    "[{user1}]({USERNAME}) {hits} {victim} in the face with a {item}.",
    "[{user1}]({USERNAME}) {hits} {victim} around a bit with a {item}.",
    "[{user1}]({USERNAME}) {throws} a {item} at {victim}.",
    "[{user1}]({USERNAME}) grabs a {item} and {throws} it at {victim}'s face.",
    "[{user1}]({USERNAME}) {hits} a {item} at {victim}.",
    "[{user1}]({USERNAME}) {throws} a few {item} at {victim}.",
    "[{user1}]({USERNAME}) grabs a {item} and {throws} it in {victim}'s face.",
    "[{user1}]({USERNAME}) launches a {item} in {victim}'s general direction.",
    "[{user1}]({USERNAME}) sits on {victim}'s face while slamming a {item} {where}.",
    "[{user1}]({USERNAME}) starts slapping {victim} silly with a {item}.",
    "[{user1}]({USERNAME}) pins {victim} down and repeatedly {hits} them with a {item}.",
    "[{user1}]({USERNAME}) grabs up a {item} and {hits} {victim} with it.",
    "[{user1}]({USERNAME}) starts slapping {victim} silly with a {item}.",
    "[{user1}]({USERNAME}) holds {victim} down and repeatedly {hits} them with a {item}.",
    "[{user1}]({USERNAME}) prods {victim} with a {item}.",
    "[{user1}]({USERNAME}) picks up a {item} and {hits} {victim} with it.",
    "[{user1}]({USERNAME}) ties {victim} to a chair and {throws} a {item} at them.",
    "[{user1}]({USERNAME}) {hits} {victim} {where} with a {item}.",
    "[{user1}]({USERNAME}) ties {victim} to a pole and whips them {where} with a {item}.",
    "[{user1}]({USERNAME}) gave a friendly push to help {victim} learn to swim in lava.",
    "[{user1}]({USERNAME}) sent {victim} to /dev/null.",
    "[{user1}]({USERNAME}) sent {victim} down the memory hole.",
    "[{user1}]({USERNAME}) beheaded {victim}.",
    "[{user1}]({USERNAME}) threw {victim} off a building.",
    "[{user1}]({USERNAME}) replaced all of {victim}'s music with Nickelback.",
    "[{user1}]({USERNAME}) spammed {victim}'s email.",
    "[{user1}]({USERNAME}) made {victim} a knuckle sandwich.",
    "[{user1}]({USERNAME}) slapped {victim} with pure nothing.",
    "[{user1}]({USERNAME}) hit {victim} with a small, interstellar spaceship.",
    "[{user1}]({USERNAME}) quickscoped {victim}.",
    "[{user1}]({USERNAME}) put {victim} in check-mate.",
    "[{user1}]({USERNAME}) RSA-encrypted {victim} and deleted the private key.",
    "[{user1}]({USERNAME}) put {victim} in the friendzone.",
    "[{user1}]({USERNAME}) slaps {victim} with a DMCA takedown request!",
]
